 ...
 */
final class Version20231020060956 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE order_item ADD book_id INT DEFAULT NULL, ADD price VARCHAR(255) NOT NULL, ADD quantity VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE order_item DROP book_id, DROP price, DROP quantity');
