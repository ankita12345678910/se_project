 ...
 */
final class Version20230818170858 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE web_book (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, prize VARCHAR(255) NOT NULL, price VARCHAR(255) NOT NULL, pages VARCHAR(255) NOT NULL, edition VARCHAR(255) NOT NULL, publisher VARCHAR(255) NOT NULL, author VARCHAR(255) NOT NULL, language VARCHAR(255) NOT NULL, binding VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
